...
The second method is to define and use functions within your code that do specific tasks. Functions are powerful because you can send in how ever many different kinds of variables you want and can choose to return what you want as well. They are really good for doing repetative tasks like scanning arrays or calculating data. This is how you define and call a function:
   ...
   Int = Function(var1, var2, var3, ...) 

When making a function such as this, you always need to make sure your returning a acceptable value of N. 
